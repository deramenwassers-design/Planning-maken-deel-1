...
Bevestigingstekens — ook uitzonderingen: ✅ (U+2705), ❌ (U+274C), ❎ (U+274E) en ❓ (U+2753). Die zet de skill `bevestigingen-opvolgen` achteraan de naam om te tonen of de klant bevestigd heeft. Er hoort er precies één te staan, helemaal achteraan. Laat dat teken staan waar het staat.
Twee uitzonderingen op de uitzondering: staan er meerdere van die vier achter elkaar, hou dan enkel het laatste over — dan is er iets misgelopen bij het zetten. En staat er zo'n teken midden in de naam in plaats van achteraan, verplaats het dan naar het einde. Verwijderen doe je ze nooit.
- Blijft staan: voor- en achternaam, alles tussen haakjes () (ongeacht inhoud), en de emoji-uitzonderingen.
- Weg moet: al de rest buiten haakjes en buiten de emoji-uitzonderingen (bv. "NM", "72€", "OCHTEND", "VOOR 11U", "OK BEVESTIGD", "JULI PROBEREN INPLANNEN", "????????", of een los pijltje "⤵️" als dat letterlijk als tekst in het veld staat — komt vaak voor, altijd verwijderen).
